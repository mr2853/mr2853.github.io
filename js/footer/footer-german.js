    ...
    <div class="row g-5">
        <div class="col-lg-3 col-md-6">
            ...
            <div class="d-flex flex-column justify-content-start">
                <a class="text-secondary mb-2" href="fahrzeugtransport-europa.html"><i
                        class="bi bi-arrow-right text-primary me-2"></i>Startseite</a>
                <a class="text-secondary mb-2" href="über-uns-fahrzeugtransport-europa.html"><i class="bi bi-arrow-right text-primary me-2"></i>Über uns</a>
                <a class="text-secondary mb-2" href="fahrzeuggalerie.html"><i
                        class="bi bi-arrow-right text-primary me-2"></i>Galerie</a>
                <a class="text-secondary" href="kontakt-transport-europa.html"><i
