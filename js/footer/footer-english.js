    ...
    <div class="row g-5">
        <div class="col-lg-3 col-md-6">
            ...
            <div class="d-flex flex-column justify-content-start">
                <a class="text-secondary mb-2" href="vehicle-transportation-europe.html"><i
                        class="bi bi-arrow-right text-primary me-2"></i>Home</a>
                <a class="text-secondary mb-2" href="about-us-vehicle-transportation-europe.html"><i class="bi bi-arrow-right text-primary me-2"></i>About Us</a>
                <a class="text-secondary mb-2" href="vehicle-gallery.html"><i
                        class="bi bi-arrow-right text-primary me-2"></i>Gallery</a>
                <a class="text-secondary" href="contact-transport-europe.html"><i
